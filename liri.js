...
function getMyTweets() {
    ...
    var params = { screen_name: 'amandatran495', count: 20, exclude_replies: true, trim_user: true };
...
function spotifyThis(song) {
    ...
    //If user has not picked a song , default to 
    if (song === "") {
        song = "Come Together";
    }
...
function movieThis(movieName) {
    ...
    request("https://api.themoviedb.org/3/search/movie?api_key=" + tmdbKey + "&query=" + movieName, function (error, response, body) {
        ...
        // If no errors and the response code was 200 
